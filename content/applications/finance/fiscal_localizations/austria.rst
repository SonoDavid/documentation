...
create a new organization in the fiskaly system and generate the necessary credentials for you.
...
Click the :guilabel:`Link to FinanzOnline` button to link your fiskaly organization to the
